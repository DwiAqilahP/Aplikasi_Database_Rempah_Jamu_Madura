...
<body>
    ...
    <div class="container1">
        ...
        <div class="action-buttons">
            <a href="tambah_rempah.php" class="add-button">Tambah Rempah</a>
        </div>
        <table>
            <thead>
                <tr>
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM rempah LIMIT " . $this_page_first_result . ',' . $results_per_page;
                $result = mysqli_query($mysqli, $sql);
                ...
                ?>
                    <tr>
                        <td><?php echo $no++; ?></td>
                        <td><?php echo $data['nama_rempah']; ?></td>
                        <td><?php echo $data['ket_rempah']; ?></td>
                        <td>
                            <a href='hapus_rempah.php?id_rempah=<?php echo $data['id_rempah']; ?>'>
                                <span class="glyphicon glyphicon-trash"></span>
                            </a>&nbsp; &nbsp; &nbsp;
                            <a href='edit_rempah.php?id_rempah=<?php echo $data['id_rempah']; ?>'>
        ...
        <ul class="pagination">
            ...
            for ($page = 1; $page <= $number_of_pages; $page++) {
                echo '<li class="page-item"><a class="page-link" href="kelola_rempah.php?page=' . $page . '">' . $page . '</a></li>';
            }
            ?>
        </ul>
    </div>
