...
<body>
    ...
    <div class="container1">
        ...
        <div class="action-buttons">
            <a href="tambah_kota.php" class="add-button">Tambah kota</a>
        </div>
        <table>
            <thead>
                <tr>
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM kota LIMIT " . $this_page_first_result . ',' . $results_per_page;
                $result = mysqli_query($mysqli, $sql);
                ...
                <tr>
                    ...
                    <td><?php echo $data['ket_kota']; ?></td>
                    <td>
                        <a href='hapus_kota.php?id_kota=<?php echo $data['id_kota']; ?>'>
                            <span class="glyphicon glyphicon-trash"></span>
                        </a>&nbsp; &nbsp; &nbsp;
                        <a href='edit_kota.php?id_kota=<?php echo $data['id_kota']; ?>'>
        ...
        <ul class="pagination">
            ...
            for ($page = 1; $page <= $number_of_pages; $page++) {
                echo '<li class="page-item"><a class="page-link" href="kelola_kota.php?page=' . $page . '">' . $page . '</a></li>';
            }
            ?>
        </ul>
    </div>
