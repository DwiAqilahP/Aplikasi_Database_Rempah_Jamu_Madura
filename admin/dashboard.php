...
<body>
    ...
    <div class="container welcome">
        ...
        <form method="GET" action="">
            <div class="input-group mb-3">
                <input type="text" class="form-control" placeholder="Cari berdasarkan nama jamu/username/khasiat" name="q">
                <br><br>
   ...
   // Inisialisasi variabel pencarian
    ...
    $sql = "SELECT username, jamu.gambar_jamu, jamu.id_jamu as id, jamu.nama_jamu, GROUP_CONCAT(khasiat.khasiat SEPARATOR ', ') as khasiat
            FROM jamu
            ...
            WHERE jamu.nama_jamu LIKE '%$search_query%' OR user.username LIKE '%$search_query%' OR khasiat.khasiat LIKE '%$search_query%'
    ...
    ?>
      <div class="menu-box" style="background-color:#FFFBF5">
            ...
            <p>Diproduksi oleh: <?= $data['username']; ?></p> <!-- Menampilkan nama user yang memproduksi jamu -->
