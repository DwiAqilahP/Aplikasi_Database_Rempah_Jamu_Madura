    ...
    <div class="container1">
        ...
        <table>
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM jamu left join user on user.id_user=jamu.id_user WHERE jamu.id_user = '$id_user'";
                ...
                $sql = "SELECT * FROM jamu left join user on user.id_user=jamu.id_user WHERE jamu.id_user = '$id_user' LIMIT " . $this_page_first_result . ',' . $results_per_page ;
                $result = mysqli_query($mysqli, $sql);
