...
if (isset($_POST['submit'])) {
    ...
    if ($file_error === 0) {
        ...
        $sql = mysqli_query($mysqli, "UPDATE jamu SET nama_jamu = '$nama_jamu', ket_jamu = '$ket_jamu', gambar_jamu = '$file_name' WHERE id_jamu = '$id_jamu'");
    } else {
        // Update data ke dalam database tanpa mengubah gambar
        $sql = mysqli_query($mysqli, "UPDATE jamu SET nama_jamu = '$nama_jamu', ket_jamu = '$ket_jamu' WHERE id_jamu = '$id_jamu'");
    }
